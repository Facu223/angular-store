...
export const products: Array<product> = [
    ...
    },
    {
        ...
        description: "The Galaxy A03 combines Octa-core processing power with up to 3GB or 4GB of RAM, depending on the model. No matter the task, you'll have fast and efficient performance. You can enjoy the best content with 32 GB, 64 GB or 128 GB of internal storage."
    },
    {
        id: 3,
        ...
        description: "The Pro Max is a 6.7-inch OLED super retina XDR with a 2778 x 1284 resolution. This is the largest iPhone to date and with the best resolution, but it's not that big of a difference compared to the iPhone 12 Pro. The A14 chip Bionic is one of the most advanced components of the iPhone 12 family."
    },
    {
        id: 4,
        name: "LG K41S",
